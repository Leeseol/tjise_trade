...
<section id="main-content">
  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
     ...
     <form action="ctrl/insertadmin.php" role="form" method="post">
    <input type="hidden" class="form-control" name="adid" value=""/>
   <div class="form-group has-success has-feedback">
      <label class="control-label" for="adname">管理员姓名：</label>
      <input type="text" class="form-control" name="adname" value=""/>
      <span class="glyphicon glyphicon-ok form-control-feedback"></span>
   </div>
  <div class="form-group has-success has-feedback">
      <label class="control-label" for="adpwd">管理员密码：</label>
      <input type="text" class="form-control" name="adpwd" value=""/>
      <span class="glyphicon glyphicon-ok form-control-feedback"></span>
   </div>
