...
$sql="select smalltype_id,smalltype_name,smalltype_info,bigtype.bigtype_name from smalltype,bigtype where smalltype.bigtype_id=bigtype.bigtype_id and smalltype_id=".$_GET['scid'];
$rs = $conn->query($sql);
$att1= $rs->fetch_row();
?>
<!DOCTYPE html>
...
<section class="wrapper">
  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
     ...
     <form action="ctrl/updatesmalltype.php" role="form" method="post">
    <input type="hidden" class="form-control" name="scid" value="<?php echo $att1[0];?>"/>
   <div class="form-group has-success has-feedback">
      <label class="control-label" for="scname">类别名称：</label>
      <input type="text" class="form-control" name="scname" value="<?php echo $att1[1];?>"/>
      <span class="glyphicon glyphicon-ok form-control-feedback"></span>
   </div>
      <div class="form-group has-warning has-feedback">
      <label class="control-label" for="smalltypeInfo">类别详情</label>
      <script type="text/plain" name="smalltypeInfo" id="myEditor" style="width:1000px;height:240px;">
       <?php echo $att1[2];?>
      </script>
