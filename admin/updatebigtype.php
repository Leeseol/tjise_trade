...
$sql="select bigtype_id, bigtype_name,bigtype_info from bigtype where bigtype_id=".$_GET['bcid'];
$rs = $conn->query($sql);
$att1= $rs->fetch_row();
?>
<!DOCTYPE html>
...
<section class="wrapper">
  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
     ...
     <form action="ctrl/updatebigtype.php" role="form" method="post">
    <input type="hidden" class="form-control" name="bcid" value="<?php echo $att1[0];?>"/>
   <div class="form-group has-success has-feedback">
      <label class="control-label" for="bcname">类别名称：</label>
      <input type="text" class="form-control" name="bcname" value="<?php echo $att1[1];?>"/>
      <span class="glyphicon glyphicon-ok form-control-feedback"></span>
   </div>
      <div class="form-group has-warning has-feedback">
      <label class="control-label" for="bigtypeInfo">类别详情</label>
      <script type="text/plain" name="bigtypeInfo" id="myEditor" style="width:1000px;height:240px;">
       <?php echo $att1[2];?>
      </script>
