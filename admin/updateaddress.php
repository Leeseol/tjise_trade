...
$sql="select address_id,address_name from address where address_id=".$_GET['adid'];
$rs = $conn->query($sql);
$att1= $rs->fetch_row();
?>
<!DOCTYPE html>
...
<section class="wrapper">
  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
     ...
     <form action="ctrl/updateaddress.php" role="form" method="post">
    <input type="hidden" class="form-control" name="adid" value="<?php echo $att1[0];?>"/>
   <div class="form-group has-success has-feedback">
      <label class="control-label" for="adname">地址名称：</label>
