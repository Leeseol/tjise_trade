...
$sql="select admin_id,admin_name,admin_pwd from admin where admin_id=".$_GET['adid'];
$rs = $conn->query($sql);
$att1= $rs->fetch_row();
?>
<!DOCTYPE html>
...
<section class="wrapper">
  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
     ...
     <form action="ctrl/updateadmin.php" role="form" method="post">
    <input type="hidden" class="form-control" name="adid" value="<?php echo $att1[0];?>"/>
   <div class="form-group has-success has-feedback">
      <label class="control-label" for="adname">管理员姓名：</label>
      <input type="text" class="form-control" name="adname" value="<?php echo $att1[1];?>"/>
      <span class="glyphicon glyphicon-ok form-control-feedback"></span>
   </div>
  <div class="form-group has-success has-feedback">
      <label class="control-label" for="adpwd">管理员密码：</label>
      <input type="text" class="form-control" name="adpwd" value="<?php echo $att1[2];?>"/>
      <span class="glyphicon glyphicon-ok form-control-feedback"></span>
   </div>
