...
<?php
    ...
    $result4=mysqli_query($con,"SELECT * FROM goods WHERE examine='通过' order by goods_id desc limit 4");
				...
				<div class="item-brand c-item">
					...
					<div class="brand-wrapper">
						...
						<div class="bd clearfix">
							<!--<a href="#" class="brand-item" target="_blank"><img src="img/book.png" alt="图书音像"></a>
							<a href="#" class="brand-item" target="_blank"><img src="img/ele.png" alt="电子产品"></a>
							<a href="#" class="brand-item" target="_blank"><img src="img/beautify.png" alt="美容保健"></a>
							<a href="#" class="brand-item" target="_blank"><img src="img/outdoor.png" alt="文体户外"></a>
							<a href="#" class="brand-item" target="_blank"><img src="img/custume.png" alt="服装衣帽"></a>
							<a href="#" class="brand-item" target="_blank"><img src="img/life.png" alt="生活用品"></a>
							<a href="#" class="brand-item" target="_blank"><img src="img/other.png" alt="其他"></a>-->
		...
		<div id="main">
			            ...
			            ?>
									<li class="pve">
										<a href="details.php?goodsid=<?php echo $row['goods_id']?>" target="_blank"> <span class="icon icon_th"></span>
											<div class="car-pic div0"> 
												<img src="<?php echo $row['goods_img']?>" height="90%" />
												 </div>
											<div class="price">
					...
					<div class="inBox clearfix">
			            ...
			            ?>
									<li class="pve">
										<a href="details.php?goodsid=<?php echo $row['goods_id']?>" target="_blank">
											<div class="car-pic"> 
												<img src="<?php echo $row['goods_img']?>" height="228"> 
												</div>
										</a>
									</li>
						<?php
   	                     ...
   	                     ?>	
   	                                <li class="pve liHd">
										<a href="Cars/index/channel/2/id/949.html" target="_blank">
											 <img src="img/chang1.jpg" class="imgVt" width="480px" height="226px" />
											  </a>
									</li>
								</ul>
							</div>
			...
			<div class="he_3DFlipY_inner">
				<div class="he_3DFlipY_img">
					<img src="<?php echo $row['goods_img']?>" height="100%" class="imgVt" alt="img01"> <span class="icon icon_th"></span> 
				</div>
				<div class="he_3DFlipY_caption">
					<h3><?php echo $row['goods_name']?></h3>
					<p><font style="font-size: 16px;">只需 <?php echo $row['goods_price']?> 元 即可拿到</font></p>
				</div>
				<a href="details.php?goodsid=<?php echo $row['goods_id']?>"></a>
			 </div>
		</div>
							<?php
                             }
			...
			<div class="p-dl">
				<form class="registForm" enctype="multipart/form-data" method="post" name="reg" id="reg" action="ctrl/insertusers.php">
					 <ul class="login-items">
			            ...
			            <li class="clearfix">
			                <input class="input" type="text" value="" id="usernames"  name="realname" placeholder="请输入您的用户名">
			            </li>
			            <li class="clearfix">
			                <input id="" class="input" type="text" id="userpassword" name="password" value="" placeholder="请输入输入密码">
			            </li>
			        </ul>
			        ...
			        <div class="login-button">
                    	<input type="hidden" value="" name="carid" class="ordercarid" />
                        <input type="hidden" value="" name="carstatus" class="orderstatus" />
			            <input type="button"  value="立即注册" class="fM" onclick="clickto()" />
			        </div>
