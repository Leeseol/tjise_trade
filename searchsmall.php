<?php
	...
	$result=mysqli_query($con,"select goods_id,goods_img,goods_name,goods_price,goods_data,goods_ps,smalltype.smalltype_name FROM goods,smalltype where smalltype.smalltype_id=goods.smalltype_id and smalltype_name LIKE '%".$keyword."%'");
			...
			<div class="head-search">
				<div class="wrap clearfix">
					<div class="yjxj clearfix left">
						<form action="searchsmall.php" method="post" enctype="multipart/form-data">
              ...
              <img src="<?php echo $row['goods_img'];?>"  width="300" /></a> </span>
									<div class="carTxt right dInline" style="margin-top: 10px;">
										...
										<div class="cs_bt clearfix" style="padding-top:7px;">
											<a href="details.php?goodsid=<?php echo $row['goods_id']?>" class="cs-q" id="Order_1165">查看详情</a>
